...
def generate_launch_description():
    ...
    world_model_path = os.path.join(get_package_share_directory('gazebo_models_worlds_collection'), 'models')
    ...
    world = os.path.join(
        get_package_share_directory('gazebo_models_worlds_collection'),
        'worlds',
        'forest.world'
    )
